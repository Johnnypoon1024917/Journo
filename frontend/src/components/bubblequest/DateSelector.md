...
```tsx
import { DateSelector } from '@/components/bubblequest';
...
### Selected Date Pill
- Background: `from-bubblequest-primary-500 to-bubblequest-primary-400` gradient
- Text: White
- Shadow: `shadow-lg`

### Unselected Date Pill
- Background: `bg-white` (light mode) / `bg-bubblequest-neutral-800` (dark mode)
- Border: `border-bubblequest-neutral-200` (light mode) / `border-bubblequest-neutral-700` (dark mode)
- Hover: `hover:border-bubblequest-primary-300` with background tint
...
- `bubblequest-primary-*`: Primary color shades for selected state
- `bubblequest-neutral-*`: Neutral colors for unselected state
- `bubblequest-cream-50`: Background color for gradient edges
