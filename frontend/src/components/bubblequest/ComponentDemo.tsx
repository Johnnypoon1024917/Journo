/**
 * BubbleQuest Components Demo
 * 
 * A demo page showcasing all BubbleQuest UI components.
...
export const ComponentDemo: React.FC = () => {
  ...
  return (
    <BrowserRouter>
      <div className="min-h-screen bg-bubblequest-neutral-50 dark:bg-bubblequest-neutral-900 p-8 pb-24">
        <div className="max-w-6xl mx-auto space-y-12">
        {/* Header */}
        <div className="text-center">
          <h1 className="text-4xl font-bold text-bubblequest-neutral-900 dark:text-white mb-2">
            BubbleQuest UI Components
          </h1>
          <p className="text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400">
            A showcase of all bubblequest-style components with Framer Motion animations
          </p>
        </div>

        {/* Buttons Section */}
        <Card variant="elevated" padding="lg">
          <h2 className="text-2xl font-semibold mb-6 text-bubblequest-neutral-900 dark:text-white">
            Buttons
          </h2>
          <div className="space-y-6">
            {/* Variants */}
            <div>
              <h3 className="text-sm font-medium text-bubblequest-neutral-700 dark:text-bubblequest-neutral-300 mb-3">
                Variants
              </h3>
        ...
        <Card variant="elevated" padding="lg">
          ...
          <p className="text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400 mb-4">
            The FAB appears in the bottom-right corner with a pulse animation.
            Scroll down to see it in action!
          </p>
          <div className="h-64 bg-bubblequest-neutral-100 dark:bg-bubblequest-neutral-800 rounded-lg flex items-center justify-center">
            <p className="text-bubblequest-neutral-500">
        ...
        <Card variant="elevated" padding="lg">
          ...
          <div className="bg-bubblequest-neutral-100 dark:bg-bubblequest-neutral-800 rounded-lg p-4">
            <p className="text-sm text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400 mb-2">
              Features:
            </p>
            <ul className="list-disc list-inside text-sm text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400 space-y-1">
          ...
          <div className="mt-4 p-4 bg-bubblequest-cream dark:bg-bubblequest-neutral-700 rounded-lg">
