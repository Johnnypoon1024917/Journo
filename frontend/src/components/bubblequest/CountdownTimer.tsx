/**
 * BubbleQuest CountdownTimer Component
 * 
    ...
    <div className="flex flex-col items-center">
      <div className="relative h-16 w-16 sm:h-20 sm:w-20 flex items-center justify-center">
        <AnimatePresence mode="popLayout">
          ...
          >
            <span className="text-3xl sm:text-4xl font-bold text-bubblequest-primary-600 dark:text-bubblequest-primary-400">
              {value.toString().padStart(2, '0')}
            </span>
          </motion.div>
        </AnimatePresence>
      </div>
      <span className="text-xs sm:text-sm font-medium text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400 mt-1">
        {label}
      </span>
    </div>
  );
  ...
  return (
    <div
      className={cn(
        ...
        'rounded-3xl p-6 shadow-bubblequest-sm',
    ...
    >
      ...
      <div className="flex items-baseline gap-2 mb-4">
        <span className="text-5xl font-bold text-bubblequest-600 dark:text-bubblequest-400">
          {displayDays}
        </span>
        <span className="text-lg text-neutral-600 dark:text-neutral-400">天</span>
        
        <span className="text-3xl font-bold text-bubblequest-600 dark:text-bubblequest-400 ml-2">
          {displayHours.toString().padStart(2, '0')}
        </span>
        <span className="text-lg text-neutral-600 dark:text-neutral-400">:</span>
        
        <span className="text-3xl font-bold text-bubblequest-600 dark:text-bubblequest-400">
