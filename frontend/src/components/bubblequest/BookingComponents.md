...
This document describes the booking-related components for the BubbleQuest UI redesign.
...
**Usage:**
```tsx
import { BookingTabs } from '@/components/bubblequest/BookingTabs';
...
import { BookingTabs, BoardingPassCard, AccommodationCard } from '@/components/bubblequest';
