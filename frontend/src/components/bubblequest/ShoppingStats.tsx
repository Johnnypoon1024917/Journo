/**
 * BubbleQuest ShoppingStats Component
 * 
  ...
  return (
    <div className={cn('space-y-4', className)}>
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2 rounded-lg bg-bubblequest-primary/10">
              <ShoppingBagIcon className="w-5 h-5 text-bubblequest-primary" />
            </div>
      ...
      <div className={cn(
        ...
        {/* Total count */}
        <div className="mt-2 text-xs text-center text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400">
