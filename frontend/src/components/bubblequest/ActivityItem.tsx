/**
 * BubbleQuest ActivityItem Component
 * 
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        'hover:border-bubblequest-primary-300 dark:hover:border-bubblequest-primary-600',
    ...
    >
      ...
      {showDragHandle && (
        <div className="flex-shrink-0 cursor-grab active:cursor-grabbing">
          <Bars3Icon className="w-5 h-5 text-bubblequest-neutral-400 dark:text-bubblequest-neutral-500" />
        </div>
      )}
      ...
      <div className="flex-shrink-0 w-16 text-center">
        {activity.time_start ? (
          <div className="flex flex-col items-center">
            <ClockIcon className="w-4 h-4 text-bubblequest-neutral-400 mb-1" />
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-start justify-between gap-2">
          <h4
            className={cn(
              'font-medium text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100',
              completed && 'line-through text-bubblequest-neutral-500 dark:text-bubblequest-neutral-500'
            )}
          >
            {activity.name}
          </h4>
          ...
          <button
            ...
            className={cn(
              'flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-bubblequest-primary-500 rounded',
              'transition-colors duration-200',
          ...
          >
            {completed ? (
              <CheckCircleIconSolid className="w-5 h-5 text-bubblequest-primary-500 dark:text-bubblequest-primary-400" />
            ) : (
              <CheckCircleIcon className="w-5 h-5 text-bubblequest-neutral-300 dark:text-bubblequest-neutral-600 hover:text-bubblequest-primary-400 dark:hover:text-bubblequest-primary-500" />
            )}
          </button>
        </div>
        ...
        {hasLocation && (
          <button
            ...
            className={cn(
              ...
              'hover:underline focus:outline-none focus:ring-2 focus:ring-bubblequest-primary-500 rounded',
              completed && 'text-bubblequest-neutral-500 dark:text-bubblequest-neutral-500'
            )}
        ...
        {activity.notes && (
          <p
            className={cn(
              'mt-1 text-sm text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400 line-clamp-2',
              completed && 'text-bubblequest-neutral-500 dark:text-bubblequest-neutral-500'
            )}
          >
            {activity.notes}
        ...
        {activity.travel_time_text && (
          <div className="mt-1 flex items-center gap-1 text-xs text-bubblequest-neutral-500 dark:text-bubblequest-neutral-500">
            <span>🚶</span>
