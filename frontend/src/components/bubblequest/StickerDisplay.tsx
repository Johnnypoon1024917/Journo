            ...
            <div className="relative group">
              ...
              {editable && (
                <>
                  ...
                  {/* Resize Controls - BubbleQuest Style - stays same size regardless of sticker scale */}
                  <div 
                  ...
                  >
                    <div className="flex items-center gap-1 sm:gap-1.5 md:gap-2 bg-white dark:bg-gray-800 rounded-full shadow-lg px-1.5 sm:px-2 md:px-2.5 py-0.5 sm:py-1 md:py-1.5 border border-bubblequest-300 dark:border-bubblequest-600">
                      ...
                      <button
                        ...
                        className="
                          w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full
                          bg-gradient-to-br from-bubblequest-400 to-bubblequest-500
                          dark:from-bubblequest-500 dark:to-bubblequest-600
                          text-white font-bold text-xs sm:text-sm md:text-base
                          flex items-center justify-center
                          hover:scale-110 active:scale-95
                          transition-transform
