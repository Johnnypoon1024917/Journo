  ...
  return (
    <div className="min-h-screen bg-bubblequest-neutral-50 dark:bg-bubblequest-neutral-900 p-6">
      <div className="max-w-2xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100 mb-6">
          Checklist Components Demo
        </h1>
        ...
        {items.length === 0 && (
          <div className="text-center py-12 text-bubblequest-neutral-500 dark:text-bubblequest-neutral-400">
