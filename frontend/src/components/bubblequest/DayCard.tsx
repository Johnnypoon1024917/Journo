    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-baseline gap-3">
          <span className="text-bubblequest-500 text-sm font-medium">{dayOfWeek}</span>
          <span className="text-bubblequest-500 text-6xl font-bold leading-none">{dayNumber}</span>
      ...
      {hotel && (
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-bubblequest-100 rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 flex items-center justify-center">
                      <span className="text-bubblequest-500 text-xs font-medium">
