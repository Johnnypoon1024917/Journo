/**
 * BubbleQuest ExpenseItem Component
 * 
        ...
        <div className="flex items-center gap-4 p-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-baseline justify-between gap-2 mb-1">
              <div className="text-sm font-medium text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400 capitalize">
                {t(`budget.categories.${expense.category}`)}
              </div>
              <div className="text-lg font-bold text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100">
                {formatCurrency(expense.amount, expense.currency)}
              </div>
            </div>

            {/* Date */}
            <div className="text-sm text-bubblequest-neutral-500 dark:text-bubblequest-neutral-400 mb-1">
              {formatDate(expense.date)}
            </div>

            {/* Notes */}
            {expense.notes && (
              <div className="text-sm text-bubblequest-neutral-600 dark:text-bubblequest-neutral-300 line-clamp-2">
                {expense.notes}
              </div>
            )}
          </div>
