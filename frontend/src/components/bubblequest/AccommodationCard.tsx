/**
 * BubbleQuest AccommodationCard Component
 * 
      ...
      >
        ...
        {showCustomImage ? (
          ...
          <div className="relative h-48 overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" />
            {/* Map indicator badge */}
            <div className="absolute top-3 right-3 bg-white/90 dark:bg-bubblequest-neutral-800/90 backdrop-blur-sm px-3 py-1.5 rounded-full flex items-center gap-1.5 shadow-md">
              <MapPinIcon className="w-4 h-4 text-bubblequest-primary-600 dark:text-bubblequest-primary-400" />
              <span className="text-xs font-medium text-bubblequest-neutral-700 dark:text-bubblequest-neutral-300">
                Map View
              </span>
            </div>
          </div>
        ) : (
          <div className="relative h-48 bg-gradient-to-br from-bubblequest-primary-100 to-bubblequest-primary-200 dark:from-bubblequest-primary-900 dark:to-bubblequest-primary-800 flex items-center justify-center">
            <BuildingOffice2Icon className="w-20 h-20 text-bubblequest-primary-400 dark:text-bubblequest-primary-600" />
          </div>
        )}
        ...
        <div className="p-5">
          ...
          <div className="flex items-start justify-between gap-3 mb-4">
            <div className="flex-1 min-w-0">
              ...
              {booking.confirmationNumber && (
                <p className="text-xs text-bubblequest-neutral-500 dark:text-bubblequest-neutral-400 mt-1">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Arrow */}
            <div className="flex-shrink-0 text-bubblequest-neutral-300 dark:text-bubblequest-neutral-600">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          {/* Notes */}
          {booking.notes && (
            <div className="mt-4 pt-4 border-t border-bubblequest-neutral-200 dark:border-bubblequest-neutral-700">
              <p className="text-sm text-bubblequest-neutral-600 dark:text-bubblequest-neutral-300 line-clamp-2">
                {booking.notes}
              </p>
            </div>
