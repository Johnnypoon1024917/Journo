    ...
    <div className="min-h-screen bg-bubblequest-cream-50 dark:bg-bubblequest-neutral-900 p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100">
            Basic Activities
          </h2>
        ...
        {/* Usage Instructions */}
        <section className="bg-white dark:bg-bubblequest-neutral-800 rounded-lg p-6 space-y-4">
          <h2 className="text-2xl font-semibold text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100">
            Usage Instructions
          </h2>
          <div className="space-y-2 text-sm text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400">
            <p>
