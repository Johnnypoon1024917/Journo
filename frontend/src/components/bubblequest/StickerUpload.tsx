      ...
      {!preview ? (
        ...
        <div>
          ...
          <button
            ...
            className="w-full h-40 border-2 border-dashed border-gray-300 rounded-xl hover:border-bubblequest-500 hover:bg-white/50 transition-colors flex flex-col items-center justify-center gap-3 bg-white/30"
          >
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="flex-1 px-6 py-3 bg-bubblequest-500 text-white rounded-full hover:bg-bubblequest-600 transition-colors disabled:opacity-50 flex items-center justify-center gap-2 font-medium shadow-md"
            >
              {isUploading ? (
                <>
