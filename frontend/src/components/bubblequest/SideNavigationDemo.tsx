...
const DemoPage: React.FC<{ title: string }> = ({ title }) => (
  <div className="p-8">
    <h1 className="text-3xl font-bold text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100 mb-4">
      {title}
    </h1>
    <Card className="p-6">
...
export const SideNavigationDemo: React.FC = () => {
  ...
  return (
    <BrowserRouter>
      <div className="flex min-h-screen bg-bubblequest-neutral-50 dark:bg-bubblequest-neutral-950">
        {/* Side Navigation */}
        <SideNavigation
          activeTab={activeTab}
