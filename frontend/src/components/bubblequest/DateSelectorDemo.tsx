    ...
    <div className="min-h-screen bg-bubblequest-cream-50 dark:bg-bubblequest-neutral-900 p-8">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <Card>
          ...
          />
          <div className="mt-4 p-4 bg-bubblequest-primary-50 dark:bg-bubblequest-primary-900/20 rounded-lg">
        ...
        <Card>
          ...
          <ul className="space-y-2 text-bubblequest-neutral-700 dark:text-bubblequest-neutral-300">
            <li className="flex items-start gap-2">
              <span className="text-bubblequest-primary-500 mt-1">✓</span>
        ...
        <Card>
          ...
          <pre className="bg-bubblequest-neutral-100 dark:bg-bubblequest-neutral-800 p-4 rounded-lg overflow-x-auto text-sm">
            <code>{`import { DateSelector } from '@/components/bubblequest';
