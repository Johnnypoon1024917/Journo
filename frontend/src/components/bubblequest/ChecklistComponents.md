...
This document describes the Checklist components for the BubbleQuest UI redesign.
...
**Usage:**
```tsx
import { ChecklistItem } from '@/components/bubblequest';
...
**Usage:**
```tsx
import { ChecklistProgress } from '@/components/bubblequest';
...
- **Colors:** `bubblequest-primary`, `bubblequest-neutral-*`
