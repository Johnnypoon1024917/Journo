...
const DayCardDemo: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bubblequest-cream-50 dark:bg-bubblequest-neutral-900 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-bubblequest-primary-600 dark:text-bubblequest-primary-400 mb-2">
          DayCard Component Demo
        </h1>
        ...
        {/* Features list */}
        <div className="mt-8 bg-white dark:bg-bubblequest-neutral-800 rounded-xl p-6 shadow-md">
          <h2 className="text-xl font-bold text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100 mb-4">
            Features
          </h2>
          <ul className="space-y-2 text-bubblequest-neutral-700 dark:text-bubblequest-neutral-300">
            ...
            <li>✅ Cream background with BubbleQuest styling</li>
        ...
        <div className="mt-8 bg-white dark:bg-bubblequest-neutral-800 rounded-xl p-6 shadow-md">
          ...
          <pre className="bg-bubblequest-neutral-100 dark:bg-bubblequest-neutral-900 p-4 rounded-lg overflow-x-auto text-sm">
            <code>{`import { DayCard } from '@/components/bubblequest/DayCard';
