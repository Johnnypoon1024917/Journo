...
export const FontSizeSlider: React.FC<FontSizeSliderProps> = ({
  ...
  const { fontSize, setFontSize } = useBubbleQuestThemeStore();
  ...
  return (
    <Card className={cn('p-6', className)}>
          ...
          return (
            <button
              ...
              className={cn(
                ...
                'focus:outline-none focus-visible:ring-2 focus-visible:ring-bubblequest-primary-500/20 rounded-lg p-2',
                isActive && 'text-bubblequest-primary-600 dark:text-bubblequest-primary-400'
              )}
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  isActive
                    ? 'text-bubblequest-primary-600 dark:text-bubblequest-primary-400 font-medium'
      ...
      <motion.div
        ...
        className="p-4 rounded-lg bg-bubblequest-neutral-50 dark:bg-bubblequest-neutral-800 border border-bubblequest-neutral-200 dark:border-bubblequest-neutral-700"
      >
        <p className="text-xs text-bubblequest-neutral-500 dark:text-bubblequest-neutral-400 mb-2">
          Preview:
        </p>
        <p
          className="text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100 leading-relaxed"
      ...
      {fontSize !== 16 && (
        <motion.button
          ...
          className={cn(
            ...
            'text-sm font-medium',
            'text-bubblequest-primary-600 dark:text-bubblequest-primary-400',
            'bg-bubblequest-primary-50 dark:bg-bubblequest-primary-900/20',
            'border border-bubblequest-primary-200 dark:border-bubblequest-primary-800',
            'hover:bg-bubblequest-primary-100 dark:hover:bg-bubblequest-primary-900/30',
            'transition-colors',
      ...
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={{ opacity: 1, y: 0 }}
        className="mt-4 p-3 rounded-lg bg-bubblequest-primary-50 dark:bg-bubblequest-primary-900/20 border border-bubblequest-primary-200 dark:border-bubblequest-primary-800"
      >
