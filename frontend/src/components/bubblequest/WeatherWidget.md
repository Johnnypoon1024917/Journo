...
The `WeatherWidget` component displays weather information in a compact, bubblequest-styled card. It shows temperature, weather conditions, and precipitation probability with animated weather emojis.
...
The component uses:
- Gradient backgrounds: `from-bubblequest-primary-50 to-bubblequest-primary-100`
