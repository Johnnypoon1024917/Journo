/**
 * ResponsiveBubbleQuestNavigation Component
 * 
...
export interface ResponsiveBubbleQuestNavigationProps {
  activeTab?: string;
...
/**
 * ResponsiveBubbleQuestNavigation
 * 
 ...
 */
export const ResponsiveBubbleQuestNavigation: React.FC<ResponsiveBubbleQuestNavigationProps> = ({
  activeTab,
  onTabChange,
  sideNavCollapsed,
...
export const ResponsiveKawaiiLayout: React.FC<ResponsiveKawaiiLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen bg-bubblequest-neutral-50 dark:bg-bubblequest-neutral-950">
      <ResponsiveBubbleQuestNavigation
        activeTab={activeTab}
        onTabChange={onTabChange}
