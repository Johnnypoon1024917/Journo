/**
 * BubbleQuest Card Component
 * 
 * A container component with BubbleQuest styling for content grouping.
 * 
 * Features:
 * - Rounded corners with BubbleQuest styling
...
export const Card: React.FC<CardProps> = ({
  ...
  const variantClasses = {
    ...
    outlined: 'border-2 border-[#d5d0c2] dark:border-bubblequest-neutral-700 shadow-none',
  };
