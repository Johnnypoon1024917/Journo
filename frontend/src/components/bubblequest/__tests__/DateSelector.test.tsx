...
describe('DateSelector', () => {
  ...
  describe('Selected Date Highlighting', () => {
    it('highlights the selected date', () => {
      ...
      expect(selectedButton).toHaveClass('from-bubblequest-primary-500');
      expect(selectedButton).toHaveClass('to-bubblequest-primary-400');
    });
    ...
    it('does not highlight non-selected dates', () => {
      ...
      expect(nonSelectedButton).not.toHaveClass('from-bubblequest-primary-500');
    ...
    it('updates highlighting when selected date changes', () => {
      ...
      expect(previousButton).not.toHaveClass('from-bubblequest-primary-500');
    });
  });
