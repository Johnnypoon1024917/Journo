 ...
 * 
 * Tests for the BubbleQuest bottom navigation component.
 */
...
describe('BottomNavigation - Property Tests', () => {
  // Feature: bubblequest-ui-redesign, Property 13: Active Tab Highlighting
      ...
      fc.property(
        ...
        (activeTabId) => {
          ...
          try {
            ...
            // The active tab should have text-bubblequest-primary-600 class on both icon and label
            ...
            expect(iconSvg?.className).toMatch(/text-bubblequest-primary-600/);
            
            // Check that the label has the primary color class
            expect(labelSpan?.className).toMatch(/text-bubblequest-primary-600/);
            ...
            inactiveButtons.forEach((button) => {
              ...
              expect(iconSvg?.className).toMatch(/text-bubblequest-neutral-500/);
              expect(labelSpan?.className).toMatch(/text-bubblequest-neutral-500/);
            });
          } finally {
