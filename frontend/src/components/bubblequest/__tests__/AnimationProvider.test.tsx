...
vi.mock('@/stores/bubbleQuestThemeStore', () => ({
  useBubbleQuestThemeStore: vi.fn(),
}));
...
describe('AnimationProvider', () => {
  ...
  it('renders children', () => {
    (useBubbleQuestThemeStore as any).mockReturnValue('none');
  ...
  it('renders snow particles when animations are "snow"', () => {
    (useBubbleQuestThemeStore as any).mockReturnValue('snow');
  ...
  it('renders sakura particles when animations are "sakura"', () => {
    (useBubbleQuestThemeStore as any).mockReturnValue('sakura');
  ...
  it('respects user animation preference from theme store', () => {
    ...
    (useBubbleQuestThemeStore as any).mockImplementation(mockUseStore);
