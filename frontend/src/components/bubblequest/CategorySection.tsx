/**
 * BubbleQuest CategorySection Component
 * 
    ...
    <div className={cn('mb-4', className)}>
      ...
      <button
        ...
        className={cn(
          ...
          'rounded-2xl',
          'hover:bg-bubblequest-neutral-50 dark:hover:bg-bubblequest-neutral-750',
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <motion.div
            ...
            className="text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400"
          >
            {isExpanded ? (
          ...
          {/* Category Name */}
          <span className="text-lg font-semibold text-bubblequest-neutral-900 dark:text-bubblequest-neutral-100">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-bubblequest-neutral-600 dark:text-bubblequest-neutral-400">
