        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive
                ? 'text-white'
                : 'text-kawaii-neutral-600 dark:text-kawaii-neutral-400 hover:text-kawaii-neutral-900 dark:hover:text-kawaii-neutral-200'
            )}
            role="tab"
          ...
          >
            ...
            {isActive && (
              <motion.div
                className="absolute inset-0 bg-kawaii-primary-600 dark:bg-kawaii-primary-500 rounded-lg"
              ...
              <motion.span
                className={cn(
                  ...
                  isActive
                    ...
                    : 'bg-kawaii-neutral-200 dark:bg-kawaii-neutral-700 text-kawaii-neutral-700 dark:text-kawaii-neutral-300'
                )}
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                transition={{
