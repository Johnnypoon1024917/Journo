 ...
 * 
 * Modal for adding new activities to a trip day with full Kawaii styling.
 * 
 * Features:
 * - Activity name input
 ...
 * - Cost input (optional)
 * - Full Kawaii design system integration
      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="flex items-center gap-2 text-sm font-bold text-neutral-800 dark:text-neutral-200 mb-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-kawaii-500 to-kawaii-600 flex items-center justify-center">
          ...
          <input
            ...
            className={cn(
              ...
              errors.name
                ...
                : 'border-neutral-200 dark:border-neutral-700 focus:border-kawaii-500 focus:ring-kawaii-100'
            )}
            style={{ backgroundColor: errors.name ? 'var(--kawaii-cream)' : 'var(--kawaii-cream)' }}
            autoFocus
          />
          {errors.name && (
            <motion.p
              ...
              <motion.button
                ...
                className={cn(
                  ...
                  formData.place_type === type.value
                    ? 'border-kawaii-500 bg-gradient-to-br from-kawaii-50 to-kawaii-100 dark:from-kawaii-900/30 dark:to-kawaii-800/30 shadow-lg'
                    : 'border-neutral-200 dark:border-neutral-700 hover:border-kawaii-300'
                )}
                style={formData.place_type !== type.value ? { backgroundColor: 'var(--kawaii-cream)' } : undefined}
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
                {formData.place_type === type.value && (
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-bold text-neutral-800 dark:text-neutral-200 mb-3">
              <ClockIcon className="w-5 h-5 text-kawaii-500" aria-hidden="true" />
              Time
            </label>
            <input
              type="time"
              ...
              className={cn(
                ...
                'text-neutral-900 dark:text-neutral-100',
                'focus:outline-none focus:ring-4 focus:border-kawaii-500 focus:ring-kawaii-100',
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-bold text-neutral-800 dark:text-neutral-200 mb-3">
              <CurrencyDollarIcon className="w-5 h-5 text-kawaii-500" aria-hidden="true" />
              Cost
            </label>
            <input
              type="number"
        ...
        <div>
          <label className="flex items-center gap-2 text-sm font-bold text-neutral-800 dark:text-neutral-200 mb-3">
            <DocumentTextIcon className="w-5 h-5 text-kawaii-500" />
            Notes
          </label>
          <textarea
        ...
        <div className="flex gap-3 pt-4">
          ...
          <motion.button
            ...
            className={cn(
              'flex-1 px-6 py-4 rounded-2xl font-bold',
              'bg-gradient-to-r from-kawaii-500 to-kawaii-600',
              'text-white shadow-lg',
              'hover:from-kawaii-600 hover:to-kawaii-700',
              'transition-all duration-200',
              'disabled:opacity-50 disabled:cursor-not-allowed'
            )}
