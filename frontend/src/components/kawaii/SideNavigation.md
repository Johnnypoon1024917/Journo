...
```tsx
import { SideNavigation } from '@/components/kawaii';
import { BottomNavigation } from '@/components/kawaii';
...
The component uses the kawaii theme colors:

- **Background**: `bg-white` / `dark:bg-kawaii-neutral-900`
- **Border**: `border-kawaii-neutral-200` / `dark:border-kawaii-neutral-800`
- **Active State**: `bg-kawaii-primary-50` / `dark:bg-kawaii-primary-900/20`
- **Text**: `text-kawaii-neutral-700` / `dark:text-kawaii-neutral-300`
- **Active Text**: `text-kawaii-primary-700` / `dark:text-kawaii-primary-300`
...
- **KawaiiThemeProvider**: Provides theme context for colors
