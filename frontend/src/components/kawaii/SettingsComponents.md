...
This document describes the Settings screen components for the Kawaii UI redesign.
...
**Usage:**
```tsx
import { ThemeCustomization } from '@/components/kawaii';
...
**Usage:**
```tsx
import { FontSizeSlider } from '@/components/kawaii';
...
**Usage:**
```tsx
import { DarkModeToggle } from '@/components/kawaii';
...
**Usage:**
```tsx
import { AnimationSelector } from '@/components/kawaii';
...
**Usage:**
```tsx
import { LanguageSelector } from '@/components/kawaii';
...
All Settings components use the `useKawaiiThemeStore` Zustand store for state management:
...
- Theme settings: `kawaii-theme-settings`
- Language: `i18nextLng`
...
Run tests:
```bash
npm test -- src/components/kawaii/__tests__/SettingsComponents.test.tsx
```
...
Components use kawaii design tokens from `@/design-system/kawaii-tokens`:
