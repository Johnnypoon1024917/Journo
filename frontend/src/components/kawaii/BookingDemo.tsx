...
export const BookingDemo: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-kawaii-neutral-50 dark:bg-kawaii-neutral-900 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-kawaii-neutral-900 dark:text-white mb-2">
            Booking Components Demo
          </h1>
        ...
        <div className="space-y-4">
          {activeTab === 'tickets' ? (
            <>
              <h2 className="text-xl font-semibold text-kawaii-neutral-900 dark:text-white mb-4">
        ...
        {/* Instructions */}
        <div className="mt-12 p-6 bg-white dark:bg-kawaii-neutral-800 rounded-xl shadow-lg">
          <h3 className="text-lg font-semibold text-kawaii-neutral-900 dark:text-white mb-4">
            Interaction Guide
          </h3>
          <ul className="space-y-2 text-sm text-kawaii-neutral-600 dark:text-kawaii-neutral-400">
