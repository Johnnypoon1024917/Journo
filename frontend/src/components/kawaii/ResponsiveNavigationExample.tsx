...
import { ResponsiveKawaiiLayout } from './ResponsiveKawaiiNavigation';
...
const ExamplePage: React.FC<{ title: string }> = ({ title }) => {
  ...
  return (
    <div className="p-4 md:p-8">
      <h1 className="text-2xl md:text-3xl font-bold text-kawaii-neutral-900 dark:text-kawaii-neutral-100 mb-4">
        {title}
      </h1>
      
      <Card className="p-4 md:p-6 mb-4">
        <h2 className="text-lg font-semibold text-kawaii-neutral-900 dark:text-kawaii-neutral-100 mb-2">
          Current Layout
        </h2>
      ...
      <Card className="p-4 md:p-6">
        ...
        <ul className="mt-4 space-y-2 text-kawaii-neutral-700 dark:text-kawaii-neutral-300 list-disc list-inside">
      ...
      >
        ...
        <div className="p-4 md:p-8">
          <Card className="p-4 md:p-6">
            ...
            <div className="space-y-4 text-kawaii-neutral-700 dark:text-kawaii-neutral-300">
              <div>
                <h4 className="font-semibold mb-2">1. Import the Layout Component</h4>
                <pre className="bg-kawaii-neutral-100 dark:bg-kawaii-neutral-800 p-3 rounded-lg overflow-x-auto text-sm">
