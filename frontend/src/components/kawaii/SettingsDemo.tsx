    ...
    <div className="min-h-screen bg-kawaii-neutral-50 dark:bg-kawaii-neutral-900 p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <section className="mt-12">
          <div className="rounded-xl bg-white dark:bg-kawaii-neutral-800 shadow-md p-6">
            <h2 className="text-xl font-semibold text-kawaii-neutral-900 dark:text-kawaii-neutral-100 mb-4">
              Preview Content
            </h2>
            <p className="text-kawaii-neutral-700 dark:text-kawaii-neutral-300 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-kawaii-primary-50 dark:bg-kawaii-primary-900/20 border border-kawaii-primary-200 dark:border-kawaii-primary-800">
                <h3 className="font-semibold text-kawaii-primary-700 dark:text-kawaii-primary-300 mb-2">
                  Primary Color
                </h3>
                <p className="text-sm text-kawaii-primary-600 dark:text-kawaii-primary-400">
                  This card uses the primary color you selected.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-kawaii-neutral-100 dark:bg-kawaii-neutral-700 border border-kawaii-neutral-200 dark:border-kawaii-neutral-600">
                <h3 className="font-semibold text-kawaii-neutral-800 dark:text-kawaii-neutral-200 mb-2">
                  Neutral Colors
                </h3>
