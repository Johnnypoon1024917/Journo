...
- **Border**: `border-t border-kawaii-neutral-200` / `dark:border-kawaii-neutral-800`
- **Active Color**: `text-kawaii-primary-600` / `dark:text-kawaii-primary-400`
- **Inactive Color**: `text-kawaii-neutral-500` / `dark:text-kawaii-neutral-400`
- **Shadow**: `shadow-lg`
