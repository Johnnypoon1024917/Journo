...
export const AnimationSelector: React.FC<AnimationSelectorProps> = ({
  ...
  const { animations, setAnimations } = useKawaiiThemeStore();
          ...
          return (
            <motion.button
              ...
              className={cn(
                ...
                'focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-kawaii-primary-500',
                isSelected
                  ? 'border-kawaii-primary-500 bg-kawaii-primary-50 dark:bg-kawaii-primary-900/20'
                  : 'border-kawaii-neutral-200 dark:border-kawaii-neutral-700 bg-white dark:bg-kawaii-neutral-800 hover:border-kawaii-neutral-300 dark:hover:border-kawaii-neutral-600'
              )}
            ...
            >
              ...
              {isSelected && (
                ...
                >
                  <div className="w-6 h-6 rounded-full bg-kawaii-primary-500 flex items-center justify-center">
                    <svg
                ...
                <h4
                  className={cn(
                    ...
                    isSelected
                      ...
                      : 'text-kawaii-neutral-800 dark:text-kawaii-neutral-200'
                  )}
                >
                  {option.label}
                </h4>
              ...
              {/* Preview Text */}
              <p className="text-xs text-kawaii-neutral-400 dark:text-kawaii-neutral-500 italic">
                {option.preview}
              </p>
            </motion.button>
          );
