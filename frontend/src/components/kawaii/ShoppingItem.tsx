    ...
    <div className={cn('relative', className)}>
      ...
      >
        <div className="flex items-center gap-4 p-4">
          ...
          {/* Image thumbnail */}
          {item.image ? (
            <div className="flex-shrink-0 w-[60px] h-[60px] rounded-lg overflow-hidden bg-kawaii-neutral-100 dark:bg-kawaii-neutral-700">
              <img
                src={item.image}
                alt={item.name}
            ...
            <div className="flex-shrink-0 w-[60px] h-[60px] rounded-lg bg-kawaii-neutral-100 dark:bg-kawaii-neutral-700 flex items-center justify-center">
              <ShoppingBagIcon className="w-6 h-6 text-kawaii-neutral-400" />
            </div>
          )}
          ...
          <div className="flex-1 min-w-0">
            ...
            <div
              className={cn(
                ...
                item.checked && 'line-through text-kawaii-neutral-400 dark:text-kawaii-neutral-500'
              )}
            >
              {item.name}
            </div>
            ...
            {/* Store */}
            {item.store && (
              <div className="text-sm text-kawaii-neutral-600 dark:text-kawaii-neutral-400 mb-1">
                {item.store}
              </div>
            )}
            ...
            {item.weblink && (
              <a
                ...
                className={cn(
                  ...
                  'text-kawaii-primary hover:text-kawaii-primary-600',
                  'dark:text-kawaii-primary-400 dark:hover:text-kawaii-primary-300',
