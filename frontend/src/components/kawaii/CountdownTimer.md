...
A kawaii-styled countdown timer that displays the time remaining until a trip departure date with smooth animations and a progress bar.
...
```tsx
import { CountdownTimer } from '@/components/kawaii';
...
- **Background**: Gradient from `kawaii-primary-50` to `kawaii-primary-100`
- **Numbers**: Large, bold text in `kawaii-primary-600`
- **Labels**: Smaller text in `kawaii-neutral-600`
- **Progress Bar**: Gradient from `kawaii-primary-400` to `kawaii-primary-500`
...
This component satisfies the following requirements from the kawaii-ui-redesign spec:
