...
export const Input: React.FC<InputProps> = ({
  ...
  const baseClasses = cn(
    ...
    'placeholder:text-kawaii-neutral-400',
    'bg-white dark:bg-kawaii-neutral-800',
    'text-kawaii-neutral-900 dark:text-white'
  );
  
  const variantClasses = {
    default: cn(
      'border-kawaii-neutral-200 dark:border-kawaii-neutral-700',
      'focus:border-kawaii-primary-500 focus:ring-kawaii-primary-500/20',
      'hover:border-kawaii-neutral-300 dark:hover:border-kawaii-neutral-600'
    ),
    error: cn(
