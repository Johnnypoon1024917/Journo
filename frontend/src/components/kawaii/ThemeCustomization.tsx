...
import { useKawaiiThemeStore, kawaiiThemePresets } from '@/stores/kawaiiThemeStore';
...
export const ThemeCustomization: React.FC<ThemeCustomizationProps> = ({
  ...
  const { primaryColor, setPrimaryColor } = useKawaiiThemeStore();
  ...
  const isPresetSelected = kawaiiThemePresets.some(
  ...
  return (
    <Card className={cn('p-6', className)}>
      ...
      {/* Preset Colors */}
      <div className="mb-6">
        <label className="block text-sm font-medium text-kawaii-neutral-700 dark:text-kawaii-neutral-300 mb-3">
          Preset Colors
        </label>
            ...
            return (
              <motion.button
                ...
                className={cn(
                  ...
                  isSelected && 'ring-2 ring-offset-2 ring-kawaii-neutral-400 dark:ring-kawaii-neutral-500'
                )}
        ...
        <div className="grid grid-cols-6 gap-3 mt-2">
          {kawaiiThemePresets.map((preset) => (
            <div
              ...
              className="text-center text-xs text-kawaii-neutral-600 dark:text-kawaii-neutral-400"
            >
              {preset.name}
            </div>
          ))}
      ...
      <div>
          ...
          <motion.button
            ...
            className={cn(
              ...
              showCustomPicker || !isPresetSelected
                ? 'ring-2 ring-offset-2 ring-kawaii-neutral-400 dark:ring-kawaii-neutral-500'
                : 'border-kawaii-neutral-300 dark:border-kawaii-neutral-600'
            )}
            style={{
              ...
              <div className="mt-3 flex items-center gap-2">
                <input
                  ...
                  className={cn(
                    ...
                    'border border-kawaii-neutral-300 dark:border-kawaii-neutral-600',
                  ...
                  placeholder="var(--kawaii-primary-500)"
                />
                <div
                  className="w-10 h-10 rounded-lg border-2 border-kawaii-neutral-300 dark:border-kawaii-neutral-600"
        ...
        {!showCustomPicker && (
          <p className="mt-2 text-xs text-kawaii-neutral-500 dark:text-kawaii-neutral-400">
      ...
      <motion.div
        ...
        className="mt-6 p-4 rounded-lg bg-kawaii-primary-50 dark:bg-kawaii-primary-900/20 border border-kawaii-primary-200 dark:border-kawaii-primary-800"
      >
