/**
 * Kawaii TransportationTicketCard Component
 * 
        ...
        <div className="p-5">
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs font-medium text-kawaii-neutral-500 dark:text-kawaii-neutral-400">
                取車地點
              </span>
            </div>
            <p className="text-sm font-semibold text-kawaii-neutral-900 dark:text-kawaii-neutral-100 ml-6">
              {booking.pickupLocation}
            </p>
            <div className="flex items-center gap-2 mt-1 ml-6">
              <CalendarIcon className="w-4 h-4 text-kawaii-neutral-400 dark:text-kawaii-neutral-500" />
              <p className="text-sm text-kawaii-neutral-600 dark:text-kawaii-neutral-300">
                {booking.pickupDate}
          ...
          <div className="flex justify-center mb-4">
            <div className="text-kawaii-neutral-300 dark:text-kawaii-neutral-600">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
