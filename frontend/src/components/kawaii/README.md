...
This directory contains the kawaii-style UI components for the Journo travel platform redesign.
...
**Usage:**
```tsx
import { Button } from '@/components/kawaii';
...
**Usage:**
```tsx
import { FAB } from '@/components/kawaii';
...
**Usage:**
```tsx
import { Card } from '@/components/kawaii';
...
**Usage:**
```tsx
import { Input } from '@/components/kawaii';
...
**Usage:**
```tsx
import { Checkbox } from '@/components/kawaii';
...
**Usage:**
```tsx
import { Slider } from '@/components/kawaii';
...
All components use kawaii design tokens from `@/design-system/kawaii-tokens.ts`:
