 ...
 * 
 * Modal for adding/editing shopping items with kawaii styling matching AddActivityModal
 */
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <input
            ...
            className={cn(
              ...
              errors.name
                ...
                : 'border-neutral-200 dark:border-neutral-700 focus:border-kawaii-500 focus:ring-kawaii-100 dark:focus:ring-kawaii-900/30',
        ...
        <div>
          ...
          <input
            ...
            className={cn(
              ...
              'focus:border-kawaii-500 focus:ring-4 focus:ring-kawaii-100 dark:focus:ring-kawaii-900/30',
              ...
              return (
                <motion.button
                  ...
                  className={cn(
                    ...
                    'border-2',
                    isSelected
                      ? 'bg-gradient-to-br from-kawaii-400 to-kawaii-500 text-white border-kawaii-500 shadow-md'
                      : 'bg-white dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 border-neutral-200 dark:border-neutral-700 hover:border-kawaii-300'
                  )}
        ...
        <div className="flex gap-3 pt-4">
          ...
          <motion.button
            ...
            className={cn(
              'flex-1 px-6 py-3 rounded-2xl font-medium',
              'bg-gradient-to-br from-kawaii-500 to-kawaii-600',
