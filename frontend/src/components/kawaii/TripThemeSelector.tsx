...
import { kawaiiThemePresets } from '@/design-system/kawaii-tokens';
import type { AnimationType } from '@/stores/kawaiiThemeStore';
...
export const TripThemeSelector: React.FC<TripThemeSelectorProps> = ({
  ...
  const [theme, setTheme] = useState<TripThemeConfig>({
    primaryColor: initialTheme?.primaryColor || 'var(--kawaii-primary-500)',
  ...
  const stickerStyles: Array<{
  ...
  }> = [
    {
      ...
      description: t('tripTheme.stickerStyle.cute.description', 'Adorable kawaii characters'),
      preview: '🐰',
    },
    {
      id: 'minimal',
