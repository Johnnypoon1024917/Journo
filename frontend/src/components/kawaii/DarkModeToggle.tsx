...
export const DarkModeToggle: React.FC<DarkModeToggleProps> = ({
  ...
  const { darkMode, setDarkMode } = useKawaiiThemeStore();
  ...
  return (
    <Card className={cn('p-6', className)}>
      ...
      <motion.div
        ...
        className="mt-4 p-3 rounded-lg bg-kawaii-neutral-50 dark:bg-kawaii-neutral-800 border border-kawaii-neutral-200 dark:border-kawaii-neutral-700"
      >
        <p className="text-xs text-kawaii-neutral-600 dark:text-kawaii-neutral-400">
