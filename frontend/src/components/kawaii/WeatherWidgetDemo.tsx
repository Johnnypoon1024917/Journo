...
export const WeatherWidgetDemo: React.FC = () => {
  ...
  return (
    <div className="p-8 space-y-8 bg-kawaii-neutral-50 dark:bg-kawaii-neutral-900 min-h-screen">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-kawaii-neutral-600 dark:text-kawaii-neutral-400 mb-8">
          Displays weather information in a compact, kawaii-styled card
        </p>
        ...
        <Card className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <pre className="text-xs bg-kawaii-neutral-100 dark:bg-kawaii-neutral-800 p-2 rounded overflow-auto">
        ...
        <Card className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sampleForecasts.map((forecast, index) => (
              <div key={index}>
                <h3 className="text-sm font-medium mb-2 text-kawaii-neutral-700 dark:text-kawaii-neutral-300">
        ...
        <Card>
          ...
          <div className="space-y-4">
            <div>
              ...
              <pre className="text-xs bg-kawaii-neutral-100 dark:bg-kawaii-neutral-800 p-4 rounded overflow-auto">
