/**
 * Kawaii BoardingPassCard Component
 * 
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      >
        ...
        <div className="relative bg-[#FFF5E6] dark:bg-kawaii-neutral-800 px-6 py-4">
          <div className="flex items-center justify-between">
            {/* Flight Number */}
            <div>
              <div className="text-[#8B7355] dark:text-kawaii-neutral-400 text-xs mb-1">
                航班編號
              </div>
              <div className="text-[#4A4A4A] dark:text-kawaii-neutral-100 text-lg font-bold">
