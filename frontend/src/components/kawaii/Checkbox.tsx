    ...
    <div className={cn('flex items-start gap-3', className)}>
      <div className="relative flex items-center justify-center min-h-[44px] min-w-[44px]">
        ...
        <label
          ...
          className={cn(
            ...
            'peer-checked:bg-kawaii-primary-500 peer-checked:border-kawaii-primary-500',
            'peer-focus:ring-2 peer-focus:ring-kawaii-primary-500/20 peer-focus:ring-offset-1',
            'border-kawaii-neutral-300 dark:border-kawaii-neutral-600',
            'hover:border-kawaii-primary-400 dark:hover:border-kawaii-primary-400',
      ...
      {(label || helperText) && (
        <div className="flex-1 pt-2">
          ...
          {helperText && (
            <p className="mt-1 text-sm text-kawaii-neutral-500 dark:text-kawaii-neutral-400">
              {helperText}
            </p>
          )}
        </div>
