/**
 * Kawaii ExpenseSummary Component
 * 
...
export const ExpenseSummary: React.FC<ExpenseSummaryProps> = ({
  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <motion.div
        className={cn(
          'bg-gradient-to-br from-kawaii-primary to-kawaii-primary-dark',
          'rounded-3xl p-6',
          'shadow-lg'
        )}
      ...
      {activeCategories.length > 0 && (
        ...
        >
          <h3 className="text-lg font-bold text-kawaii-neutral-900 dark:text-kawaii-neutral-100 mb-4">
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-kawaii-neutral-700 dark:text-kawaii-neutral-300 capitalize">
                    ...
                    <div className="text-right">
                      <div className="text-sm font-bold text-kawaii-neutral-900 dark:text-kawaii-neutral-100">
                  ...
                  {/* Progress bar */}
                  <div className="h-2 bg-kawaii-neutral-100 dark:bg-kawaii-neutral-700 rounded-full overflow-hidden">
                    <motion.div
      ...
      {activeCategories.length === 0 && (
        <motion.div
          ...
          transition={{ duration: 0.3, delay: 0.1 }}
        >
          <CurrencyDollarIcon className="w-16 h-16 mx-auto mb-4 text-kawaii-neutral-300 dark:text-kawaii-neutral-600" />
