...
A kawaii-styled component for displaying individual activity/place items within a trip day.
...
```tsx
import { ActivityItem } from '@/components/kawaii/ActivityItem';
...
- `kawaii-primary-*`: Primary theme colors
- `kawaii-neutral-*`: Neutral grays
- `kawaii-cream-*`: Cream background colors
