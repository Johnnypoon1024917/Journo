...
export const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`toast-item ${isExiting ? 'toast-exit' : 'toast-enter'} flex items-center p-4 rounded-lg shadow-lg ${getStyles()}`}
      role="alert"
    ...
    >
      ...
      <button
        ...
        className="ml-auto -mx-1.5 -my-1.5 rounded-lg p-1.5 inline-flex h-8 w-8 hover:bg-black/10 dark:hover:bg-white/10 transition-smooth min-h-touch min-w-touch items-center justify-center"
      ...
      <style>{`
        ...
        .toast-exit {
          animation: toastSlideOut 200ms cubic-bezier(0.4, 0, 0.2, 1);
        }
