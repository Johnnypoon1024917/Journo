          ...
          <div className="p-8">
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                ...
                />
                <svg className="w-5 h-5 text-gray-400 absolute left-4 top-1/2 transform -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
