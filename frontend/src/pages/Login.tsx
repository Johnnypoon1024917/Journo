          ...
          <div className="absolute inset-0 flex items-center justify-center p-12">
            <div className="text-white max-w-lg">
              ...
              <p className="text-xl font-light opacity-90">
                Sign in to continue planning your perfect trips with friends and family.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-md w-full space-y-8">
            ...
            <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all"
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  type="button"
                  className="flex items-center justify-center px-4 py-3 min-h-[44px] border-2 border-[#94a3b8] rounded-xl text-sm font-medium text-gray-800 bg-white hover:bg-gray-50 hover:border-gray-500 transition-all"
                >
