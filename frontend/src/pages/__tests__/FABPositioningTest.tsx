...
export const FABPositioningTest: React.FC = () => {
  ...
  // FAB positions (notification FAB removed, indices shifted down)
  const primaryFAB = useFABPosition({ type: 'primary', index: 0, hasBottomNav: showBottomNav });
  const secondaryFAB = useFABPosition({ type: 'secondary', index: 1, hasBottomNav: showBottomNav });
  const recycleFAB = useFABPosition({ type: 'recycle', index: 2, hasBottomNav: showBottomNav });
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-green-500 pl-4">
              ...
              <p className="text-sm text-gray-600">Type: primary, Index: 0, Z-Index: 50</p>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              ...
              <p className="text-sm text-gray-600">Type: secondary, Index: 1, Z-Index: 45</p>
            ...
            <div className="border-l-4 border-red-500 pl-4">
              ...
              <p className="text-sm text-gray-600">Type: recycle, Index: 2, Z-Index: 60</p>
