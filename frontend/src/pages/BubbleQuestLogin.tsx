/**
 * BubbleQuest Login Page
 * 
 * BubbleQuest-styled login page with soft colors and playful design.
 */
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl p-8 md:p-10 border border-bubblequest-primary-100">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  type="button"
                  className="flex items-center justify-center px-4 py-3 min-h-[44px] border-2 border-[#d5d0c2] rounded-xl text-sm font-medium text-bubblequest-neutral-700 bg-white hover:bg-bubblequest-neutral-50 hover:border-bubblequest-neutral-300 transition-all"
                >
