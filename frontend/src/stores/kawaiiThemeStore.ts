/**
 * Kawaii Theme Store (Backward Compatibility Wrapper)
 * 
...
// Kawaii theme presets (for backward compatibility)
export const kawaiiThemePresets: KawaiiThemePreset[] = [
  {
    name: 'Kawaii Pink',
    value: '#FFB3BA',
 ...
 * @deprecated Use useCentralizedThemeStore instead
 */
export const useKawaiiThemeStore = () => {
