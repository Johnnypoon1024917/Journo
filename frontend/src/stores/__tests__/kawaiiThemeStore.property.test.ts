/**
 * Property-Based Tests for Kawaii Theme Store
 * 
...
import { useKawaiiThemeStore, type AnimationType } from '../kawaiiThemeStore';

describe('Kawaii Theme Store - Property Tests', () => {
    ...
    fc.assert(
      fc.property(
        ...
        (theme) => {
          ...
          const saved = localStorage.getItem('kawaii-theme-settings');
          ...
          localStorage.setItem('kawaii-theme-settings', JSON.stringify({
            state: theme,
            version: 1,
          }));
          
          // Create a new store instance to simulate page reload
          const newStore = useKawaiiThemeStore.getState();
          newStore.loadTheme();
