 ...
 * Icon Atom Component
 * 
 * Flexible icon component with support for different icon libraries,
 * sizes, colors, and accessibility features.
 */

import React, { forwardRef } from 'react';
import { cn } from '../../utils/cn';
import type { IconAtomProps } from '../types';

// Common icon components (you can extend this with your preferred icon library)
const iconComponents = {
  // Navigation icons
  'chevron-left': (props: React.SVGProps<SVGSVGElement>) => (
  ...
  'chevron-up': (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  'x-mark': (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
  ...
  'heart-filled': (props: React.SVGProps<SVGSVGElement>) => (
  ...
  'star-filled': (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
  ...
  'map-pin': (props: React.SVGProps<SVGSVGElement>) => (
    <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
const Icon = forwardRef<SVGSVGElement, IconAtomProps>(
  (
    {
      name,
      size = 'md',
