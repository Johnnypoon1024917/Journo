...
define(['./workbox-9e50c213'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https?:\/\/.*\/api\/(trip-days|places|days).*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https?:\/\/.*\/api\/(shopping|checklist|budget|expenses|packing).*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/^https?:\/\/.*\/api\/stickers.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/maps\.googleapis\.com\/.*/i, new workbox.StaleWhileRevalidate({
